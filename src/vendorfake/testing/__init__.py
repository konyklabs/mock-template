...
def _release_async_client(started: StartedUnit) -> None:
...
async def async_unit(
    ...
    *,
    ...
    """
    with unit(vendor, profile, sink=sink, env=env, logger=logger, seed=seed) as started:
        try:
            yield started
        finally:
